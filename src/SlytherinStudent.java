public class SlytherinStudent extends HogwartsStudent {
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent) {
        ...
        if (ability1 < ability2) {
            System.out.println("Слизеренец %s лучше, чем слизеренец %s: %d VS %d%n", getName(), slytherinStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.println("Слизеренец %s лучше, чем слизеренец %s: %d VS %d%n", slytherinStudent.getName(), getName(), ability2, ability1);
        } else {
